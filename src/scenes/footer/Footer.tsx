...
const Footer = () => {
  return (
    <footer className=" bg-gray-50 sm:pt-16 lg:pt-24 ">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl ">
            <div className="grid grid-cols-2 md:col-span-2 lg:grid-cols-6 gap-y-16 gap-x-12">
                <div className="col-span-2 md:col-span-12 lg:col-span-2 lg:pr-8">
            ...
            <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by BRESC Library</p>
        </div>
</footer>
